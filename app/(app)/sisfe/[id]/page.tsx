      ...
      <div className="min-w-0 space-y-6">
        <Card className="min-w-0 overflow-hidden">
          ...
          <CardContent className="min-w-0">
            ...
            </div>)}</div> : <p className="py-8 text-center text-sm text-muted-foreground">Todavía no se registraron adjuntos. Ejecutá nuevamente “Conectar y actualizar” con la extensión 0.9.3.</p>}
          </CardContent>
        </Card>
